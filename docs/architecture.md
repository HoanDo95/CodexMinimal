...
- `idsd-orchestrator -> repo-phase-orchestrator -> Codex CLI native execution -> verification -> project-indexer`
...
- it can add conditional quality gates for solution critique, system design, and senior QA evidence
